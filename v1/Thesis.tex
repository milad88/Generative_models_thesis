...
%Con queto comando si può cambaire il modo in cui verranno nominate le
	%figure. Di default è "Figura", qui viene cambiato in "Fig."
	...
	\input{file/frontespizio}
	\input{file/Dedication}
	\input{file/abstract}
	\input{file/acknowledgements}
...
%\begin{appendices}
%\input{file/appendix_ur}
%\input{file/appendix_kuka}
%\input{file/appendix_A}
%\end{appendices}
